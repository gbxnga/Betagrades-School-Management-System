...
<body class="hold-transition login-page" style="background-image:url('bg.jpg');background-size:cover">
    ...
    <div class="login-box">
            ...
            if(isset($status) && !empty($status))
            {
                ...
                echo '<div style="margin-top:15px" class="col-md-12"><div class="alert alert-success">'.$status['sta'].'</div></div>';
            }
        ...
        <div class="login-box-body">
            ...
            <form method="post">
                ...
                <div class="form-group has-feedback">
                    <input type="text" name="admission_no" class="form-control" placeholder="Admission Number">
